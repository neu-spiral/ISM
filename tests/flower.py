...
class flower(test_base):
	def __init__(self):
		...
		self.update_allocation_original_img()
	...
	def set_up_image(self):
		...
		self.orig_sigma = 0.1*np.median(d_matrix)
...
#-----	Individual Runs -----------------------------------
D.perform_default_run_full()
#D.run_with_W_0('SM', 10)
#D.random_initializations(10, 'SM')
#D.ran_single_from_pickle_init('SM', 4)
#import pdb; pdb.set_trace()
