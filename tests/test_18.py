...
if False:	# some HSIC debug stuff
	...
	alt_Y = Allocation_2_Y(b)

	[HSIC, percent_diff] = HSIC_rbf(db['data'], label_2, sigma, return_percent_diff=True )
	print 'Percent Diff alt : ' , percent_diff
	[HSIC, percent_diff] = HSIC_rbf(db['data'], alt_Y, sigma, return_percent_diff=True )
	print 'Percent Diff mine : ' , percent_diff
