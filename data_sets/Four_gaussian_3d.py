...
label1 = np.vstack((np.zeros((N/4,1)),np.ones((N/4,1)),np.zeros((N/4,1)),np.ones((N/4,1))))
label2 = np.vstack((np.zeros((N/4,1)),np.ones((N/4,1)),np.ones((N/4,1)),np.zeros((N/4,1))))

#label2 = np.vstack((np.zeros((N/4,1)),np.ones((N/4,1)),np.zeros((N/4,1)),np.ones((N/4,1))))
